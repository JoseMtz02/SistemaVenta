...
public partial class DbventaContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.IdCategoria).HasName("PK__Categori__8A3D240C9ED05012");
        ...
        {
            entity.HasKey(e => e.IdDetalleVenta).HasName("PK__DetalleV__BFE2843FC7410A2E");
        ...
        {
            entity.HasKey(e => e.IdMenu).HasName("PK__Menu__C26AF483EB356C12");
        ...
        {
            entity.HasKey(e => e.IdMenuRol).HasName("PK__MenuRol__9D6D61A4D73B3ADF");
        ...
        {
            entity.HasKey(e => e.IdNumeroDocumento).HasName("PK__NumeroDo__471E421A66B612DA");
        ...
        {
            entity.HasKey(e => e.IdProducto).HasName("PK__Producto__07F4A1329E556AC5");
        ...
        {
            entity.HasKey(e => e.IdRol).HasName("PK__Rol__3C872F76F359BA46");
        ...
        {
            entity.HasKey(e => e.IdUsuario).HasName("PK__Usuario__645723A695F34A2C");
        ...
        {
            entity.HasKey(e => e.IdVenta).HasName("PK__Venta__077D5614E86E174F");
